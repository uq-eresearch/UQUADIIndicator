...
getActiveTransportIndicator<-function(region="SEQ", year=2011,travel_mod="CarDriver",key){
  require(RCurl)
  require(jsonlite)
...
getWalkIndicator<-function(region="SEQ", year=2011,travel_mod="CarDriver",key){
  require(RCurl)
  require(jsonlite)
...
getCyclingIndicator<-function(region="SEQ", year=2011,travel_mod="CarDriver",key){
  require(RCurl)
  require(jsonlite)
